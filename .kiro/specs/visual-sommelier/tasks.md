...
- [ ] 0.1 Установка и проверка Ollama + LLaVA
...
- [ ] 0.2 Тестирование YOLOv8n для детекции
...
- [ ] 0.5 Документирование результатов POC
...
- [ ] 2.2 Настройка GPU и проверка CUDA
