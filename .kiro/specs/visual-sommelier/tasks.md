...
- [ ] 2. Настройка базовых адаптеров для внешних сервисов
  - Создать абстрактный интерфейс CVProviderAdapter
  - Создать абстрактный интерфейс LLMProviderAdapter
  - Реализовать GoogleVisionAdapter с базовыми методами
  - Реализовать OpenAIAdapter с базовыми методами
...
## Фаза 8: Офлайн-режим и кэширование

- [ ] 17. Реализация офлайн-функциональности
  - Добавить детектор состояния сети
  - Реализовать отображение уведомления об офлайн-режиме
  - Реализовать очередь запросов для офлайн-режима
  - Реализовать автоматическую обработку очереди при восстановлении сети
  - Обеспечить доступ к истории в офлайн-режиме
  - _Requirements: 7.1, 7.2, 7.3, 7.4_

- [ ]* 17.1 Написать property-тест для доступности истории офлайн
  - **Property 21: Доступность истории офлайн**
  - **Validates: Requirements 7.2**

- [ ]* 17.2 Написать property-тест для обработки очереди
  - **Property 22: Обработка очереди запросов**
  - **Validates: Requirements 7.4**

- [ ] 18. Реализация CacheManager
...
- [ ] 19. Добавление мер безопасности
  - Реализовать шифрование API ключей в localStorage
