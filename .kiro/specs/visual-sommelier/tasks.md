...
- [x] 2.1 Написать property-тест для адаптеров
...
- [x] 2.3 Написать тесты для GPU utilities
  - Тест проверки CUDA
...
- [x] 3.1 Написать unit-тесты для моделей данных
  - Тесты валидации полей
  - Тесты сериализации/десериализации

- [x] 4. Реализация ImageAnalysisService
...
- [x] 4.1 Написать property-тест для распознавания устройств
  - **Property 2: Отображение результатов распознавания**
  - **Validates: Requirements 1.2**

- [x] 4.2 Написать property-тест для низкой уверенности
  - **Property 3: Предложение категорий при низкой уверенности**
  - **Validates: Requirements 1.3**

- [x] 4.3 Написать property-тест для идентификации по координатам
  - **Property 7: Идентификация элемента по координатам**
  - **Validates: Requirements 2.4**

- [x] 5. Реализация ExplanationService
...
- [x] 5.1 Написать property-тест для соответствия языка
  - **Property 5: Соответствие языка ответа**
  - **Validates: Requirements 2.2, 5.4**

- [x] 5.2 Написать property-тест для структуры объяснения
...
- [x] 6.1 Написать property-тест для контекста сессии
